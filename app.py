...
st.markdown('<div class="main-title">🧠 LLM Powered SQL Generator</div>', unsafe_allow_html=True)
st.divider()
...
st.markdown(
    ...
    <div style="
        ...
        border-radius:8px;
    ">
        🚀 Built by <b style="color:#FFFFFF;">Pratham Soni</b> | LLM SQL Generator
    </div>
    """,
    unsafe_allow_html=True
)
